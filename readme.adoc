= Lightweight Isolation Specification
...
`git clone --recurse-submodules https://github.com/riscv/lightweight-isolation.git`
...
To start the build process, run `cd ./lightweight-isolation && make build`.
